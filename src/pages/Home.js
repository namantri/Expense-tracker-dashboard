...
const Home = () => {
    ...
    return (
        ...
        >
            ...
            <span id="top"></span>
            <div
                className={isScrolled ? "home-nav" : "home-nav scrolled"}
                id="top"
            >
                <img
                    src={
            ...
            <div className="advantages">
                <div className="adv">
                    ...
                    >
                        <img
                            src={
                                "https://moneylover.me/img/details/Transaction@4x.png"
                            }
                            alt=" "
                            className="adv-img"
                    ...
                    >
                        <div className="adv-text">
                            ...
                            <p>
                                ...
                                Put them into clear and visualized categories
                                such as Expense: Food, Shopping or Income:
                                Salary, Gift.
                            </p>
                        </div>
                    </AnimationOnScroll>
                ...
                <div className="adv">
                    ...
                    >
                        <div className="adv-text">
                            ...
                            <p>
                                One report to give a clear view on your spending
                                patterns. Understand where your money comes and
                                goes with easy-to-read graphs.
                            </p>
                        </div>
                    </AnimationOnScroll>
                </div>
            ...
            <div className="reviews">
                ...
                >
                    <div>
                        <p>
                            A simple, accessible app that allows you to budget
                            across weeks, months and years. The neat financial
                            calendar lets you set up alerts and keep tabs on all
                            transactions. Plus, it works with all currencies.
                        </p>
                        <b>Sagar Singh</b>
                    </div>
                </AnimationOnScroll>
                ...
                >
                    <div>
                        <p>
                            Perfect app. My husband and I use it to track all
                            our expenses and income. We generate our household
                            accounts and budget using this fab app. Furthermore,
                            the developers are hands-on and extremely helpful.
                ...
                >
                    <div>
                        <p>
                            This will keep you organized and in control, of
                            money you do have and money you will have. This
                            application is easy to use and will help you keep
